...
<body>
	<section class="Hui-article-box">
		<div id="iframe_box" class="Hui-article">
			<nav class="breadcrumb">
				...
				文章管理 <span class="c-gray en">&gt;</span> 新增文章 <a
			...
			<article class="page-container">
				<form class="form form-horizontal" id="form-article-add">
					...
					<div class="row cl">
						...
						<div class="formControls col-xs-8 col-sm-9">
							<textarea name="articleDigest" id="articleDigest" cols="" rows=""
								class="textarea" placeholder="最多输入200个字符" datatype="*20-100"
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" class="input-text" value="" placeholder="填写真实姓名" id="articleAuthor" name="articleAuthor">
					</div>
				</div> -->
					<div class="row cl">
						<label class="form-label col-xs-4 col-sm-2"><span
	...
	var serviceScriptArr = ["/lib/ueditor/1.4.3/ueditor.config.js","/lib/ueditor/1.4.3/ueditor.all.min.js",
	                        "/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js","/js/addArticle.js"];
